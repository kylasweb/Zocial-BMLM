...
export declare const Input: ({ placeholder, type, style, onChange, iconColor, value, onKeyUp, onKeyDown, ref, logoPosition, emailErrorStyle, emailtext, required, regexKey, regexMessage, name, preventFutureSelection, preventPastSelection, }: PropType) => import("react/jsx-runtime").JSX.Element;
export {};
