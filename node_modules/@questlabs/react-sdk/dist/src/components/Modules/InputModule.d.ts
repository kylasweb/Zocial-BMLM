import { CSSProperties, ChangeEventHandler, KeyboardEventHandler, ReactNode, RefObject } from 'react';
...
export declare const InputModule: ({ placeholder, type, style, onChange, iconColor, value, onKeyUp, onKeyDown, ref, logoPosition, children, className, }: PropType) => import("react/jsx-runtime").JSX.Element;
export {};
