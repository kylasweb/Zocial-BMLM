...
interface PropType {
    ...
    textErrorStyle?: CSSProperties | undefined | any;
    errorText?: string;
    validateInputRegex?: (validated: boolean) => void;
}
export declare const TextInputModule: ({ placeholder, type, onChange, onKeyUp, onKeyDown, iconColor, value, ref, logoPosition, textErrorStyle, errorText, required, regexKey, regexMessage, name, key, style, validateInputRegex }: PropType) => import("react/jsx-runtime").JSX.Element;
export {};
