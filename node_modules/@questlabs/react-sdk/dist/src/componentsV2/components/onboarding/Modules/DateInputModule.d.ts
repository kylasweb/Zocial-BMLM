...
interface PropType {
    ...
    dateErrorStyle?: CSSProperties | undefined;
    datetext?: string;
    required?: boolean;
...
export declare const DateInputModule: ({ placeholder, type, onChange, iconColor, value, onKeyUp, onKeyDown, ref, logoPosition, dateErrorStyle, datetext, required, regexKey, regexMessage, name, preventFutureSelection, preventPastSelection, key, style, minDate, maxDate }: PropType) => import("react/jsx-runtime").JSX.Element;
export {};
