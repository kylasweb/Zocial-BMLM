...
class MembershipTier {
    ...
    addNewMembershipTierForEntity({ membershipTier, xpThreshold, description, entityId, imageIPFS }, options) {
    ...
    getAllMembershipTiersForEntity({ entityId, limit, page } = {}, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
    ...
    updateMembershipTierForEntity({ membershipTier, description, imageIPFS, xpThreshold, entityId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
    ...
    deleteMembershipTierForEntity({ membershipTier, entityId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
    ...
    getMembershipTierDetailsForEntity({ membershipTier, entityId }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { userId, token } = this.questSdk.getUser();
                const defaultEntityId = entityId || this.questSdk.getEntityId();
